    ...
    <section class="content">
      ...
      <div class="col-xs-12">
          <div class="box">
           ...
           <a href="{{route('adminproduct.create')}}" class="btn btn-success">+Add to Product</a>
                 ...
                 @foreach($product as $value)
                  <tr>
                    ...
                    <td style="width: 120px;">
                        <form action="{{route('adminproduct.destroy',$value->id_product)}}" method="POST">
                            @method('DELETE')
                            @csrf
                            <button class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></button>
                            <a href="{{route('adminproduct.edit',['product'=> $value->id_product])}}" class="btn btn-primary"><span class="glyphicon glyphicon-pencil "></span></a>
                        </form>
                    </td>
                      </tr>
                @endforeach
