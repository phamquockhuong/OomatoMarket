      ...
      <div class="row">
        ...
        <section class="col-lg-8 connectedSortable">
         ...
         <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{route('adminproduct.store')}}" method="POST" role="form">
            	@csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="amount" id="amount" class="form-control" value="" placeholder="Input field">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="img_product" id="image" value="" >
                  
                </div>
                  <div class="form-group">
                    <img src="" id = "img" style="max-height: 200px;">
                  </div>
                 <div class="form-group">
                  ...
                  <input type="text" name="img_productList" id="imageList" value="" >
                </div>
