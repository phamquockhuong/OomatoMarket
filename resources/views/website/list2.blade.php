		...
		<div class="col-md-9">
			...
			<div class=" col-md-4 ">
				<div class="thumbnail">
					...
					<p>
						<a href="{{route('themgiohang',$sp->id_product)}}" class="btn btn-primary">Add to cart</a>
						<a href="{{route('cart_detail',$sp->id_product)}}" class="btn btn-success">Buy now</a>
					</p>
				</div>
			</div>
			@endforeach
		...
		<div class="row">
			...
			<div class=" col-md-3 ">
				<div class="thumbnail">
					...
					<p>
						<a href="{{route('themgiohang',$khac->id_product)}}" class="btn btn-primary">Add to cart</a>
						<a href="{{route('cart_detail',$khac->id_product)}}" class="btn btn-success">Buy now</a>
					</p>
				</div>
			</div>
