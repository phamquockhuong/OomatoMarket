...
<html lang="">
	<head>
		...
		<title>Shop Oomato Market</title>
	...
	<body>
		<div class="container-fluid" >
			...
			<ul class="nav navbar-nav" style="font-size: 18px;">
				<li><a style="padding-right: 40px;color: black;" href="#">Home</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/list2.php">Vegatables</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/list1.php">Fruits</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/list2.php">Meats</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/list1.php">Dried Foods</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/list2.php">Juices</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/list1.php">Pages</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/blog.php">Blogs</a></li>
				<li><a style="padding-right: 40px;color: black;" href="page/contact.php">Contact us</a></li>
				...
				<div class="owl-carousel owl-theme col-md-12">
					<div class="item">
				    	<div class="col-md-3" style="width: 100%;">
				    		<div class="thumbnail">
								<img src="image/nho.jpg" alt=""style="height: 210px;">
								<div class="caption">
									<h3>Grapes</h3>
				    ...
				    <div class="item">
				    	<div class="col-md-3" style="width: 100%;">
				    		<div class="thumbnail">
								<img src="image/chuoi.jpg" alt="" style="height: 210px;">
								<div class="caption">
									<h3>Banana</h3>
									<p class="price-products">
										8 $
				    ...
				    <div class="item">
				    	<div class="col-md-3" style="width: 100%;">
				    		<div class="thumbnail">
								<img src="image/xa_lach.jpg" alt=""style="height: 210px;">
								<div class="caption">
				    ...
				    <div class="item">
				    	<div class="col-md-3" style="width: 100%;">
				    		<div class="thumbnail">
								<img src="image/nuoc_xoai.jpg" alt=""style="height: 210px;">
								<div class="caption">
									<h3>Mango</h3>
									<p class="price-products">
										19 $
				    ...
				    <div class="item">
				    	<div class="col-md-3" style="width: 100%;">
				    		<div class="thumbnail">
								<img src="image/ogani.jpg" alt=""style="height: 210px;">
								<div class="caption">
									<h3>Orange</h3>
									<p class="price-products">
										17 $
				    ...
				    <div class="item">
				    	<div class="col-md-3" style="width: 100%;">
				    		<div class="thumbnail">
								<img src="image/ca-rot.jpg" alt="" style="height: 210px;">
								<div class="caption">
									<h3>Carrot</h3>
									<p class="price-products">
										<b>12 $</b>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-md-6 col-lg-2">
                        <div class="footer_widget">
                            ...
                            <ul>
                                <li><a href="page/blog.php">Our Blog</a></li>
                                <li><a href="#">Seach Page</a></li>
                                <li><a href="page/AboutAs.php">About Us</a></li>
