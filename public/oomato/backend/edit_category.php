...
if (isset($_GET['id'])) {
	$id = $_GET['id'];
	$data = mysqli_query($connect,"SELECT * FROM category WHERE id_cate = $id");
	$cate = mysqli_fetch_assoc($data);
}
	if(isset($_POST['name'] )){
		$name = $_POST['name'];
		$status = $_POST['status'];
		$sql = "UPDATE category SET name='$name',status='$status'WHERE id_cate = $id";
              ...
              <table class="table table-hover">
                ...
                <?php foreach ($category as $key => $value): ?>
                	<tr>
	                	...
	                	<td style="padding-left: 15px;"><?php echo $value['updated_at'] ?></td>
        ...
        <section class="col-lg-5 connectedSortable">
         ...
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><code><b>Edit the category</b></code></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="" method="POST" role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="name" id="name" class="form-control" value="<?php echo $cate['name'] ?>" placeholder="Input field">
                </div>
                <div class="form-group">
                ...
                <div class="radio">
                  <label class="col-md-6">
                    ...
                    <input type="radio" name="status" id="status" value="0"<?php echo (($cate['status']==0)?"checked" : '' )?>>
                    Hide category

                  </label>
                  <label class="col-md-6">
                    
                    <input type="radio" name="status" id="status" value="1"<?php echo (($cate['status']==1)?"checked" : '' )?>>
                    Show category
