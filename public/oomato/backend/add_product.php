                ...
                <?php foreach ($product as $key => $value): ?>
                  <tr>
                    ...
                    <?php if ($value['new_product']==0): ?>
                      <td><span class="label label-warning">&nbsp;Old&nbsp;</span></td>
                    <?php endif ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="id_cate" id="input" class="form-control" required="required">
                    ...
                    <?php foreach ($category as $key => $dm): ?>
                      <option value="<?php echo $value['id_cate'] ?>"><?php echo $dm['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
                <div class="form-group">
                  <label for="">Enter the product price</label>
                  <input type="number" name="price" id="price" class="form-control" value="" placeholder="Input field">
                </div>
                <div class="form-group">
                  <label for="">Enter the product sale price</label>
                  <input type="number" name="sale_price" id="sale_price" class="form-control" value="" placeholder="Input field">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="">Choose photos for the product</label>
                  <input type="file" name="img_product" id="img_product" class="form-control" value="" placeholder="Input field">
                </div>
                <div class="form-group">
                  <label for="">Product Description</label>
                  <input type="text" name="title" id="title" class="form-control" value="" placeholder="Input field">
                </div>
                <div class="form-group">
